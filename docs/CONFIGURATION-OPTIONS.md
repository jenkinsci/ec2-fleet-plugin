...
Number of Executors | The number of executors per instance. Change in number of executors will only affect future instances and existing instances (if any) will remain unaffected. | 1
